...
class TEDAPIRateLimitedException(TEDAPIException):
    ...
    def __init__(self):
        super().__init__("Possible Rate limiting by Powerwall - API calls paused")
...
class TEDAPIAccessDeniedException(TEDAPIException):
    ...
    def __init__(self):
        super().__init__("Access Denied: Check your Gateway Password")

class TEDAPINotConnectedException(TEDAPIException):
    """Exception class indicating TEDAPI is not able to connect"""
    def __init__(self):
        super().__init__("Not Connected - Unable to get configuration")
...
class TEDAPIPowerwallVersionException(TEDAPIException):
    ...
    def __init__(self):
        super().__init__("Powerwall version not supported")
